...
class Data:
    def __init__(self, args):
        ...
        if not args.test_only:
            ...
            print("really empty ???", len(trainset))
            ...
            print("is my trainset empty ? ", len(self.loader_train.dataset))
        ...
        print("is my testset empty ?", len(self.loader_test.dataset))
